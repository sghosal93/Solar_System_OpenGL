...
string  GLMultiTexture::_glsl_names[4] = { "texture_background", "texture_foreground", "texture_blend", "texture_middle"};
#endif
...
int GLTexture::loadAndCreateTexture(string path_and_file)
{
    ...
    // with texture 0 and the textuer variable "texture" / the asctive texture.
    if(channels == 3)
