...
private:
    ...
    static string      _glsl_names[];
#else
    const string      _glsl_names[4] = { "texture_background", "texture_middle", "texture_foreground", "texture_blend"};
#endif
...
public:
    ...
    /*!
	 ...
	 @param path_and_file_texture_1 - path and file of the third image.
     @return int - the texture id when the texture was sucessfully loaded.
     */
