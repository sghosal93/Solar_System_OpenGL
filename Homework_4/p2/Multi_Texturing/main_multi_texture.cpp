...
int main(int argc, const char * argv[])
{
    ...
    // create an apperance object 0.2 4.5 1.0 0.0
    ...
    // add the light to this apperance object 0.2 30.5 8.0
    ...
    // Create a material object shininess is 12
	...
	int texid = texture->loadAndCreateTextures("../../data/textures/landscape.bmp", "../../data/textures/animal.bmp", "../../data/textures/col_grad.bmp");
