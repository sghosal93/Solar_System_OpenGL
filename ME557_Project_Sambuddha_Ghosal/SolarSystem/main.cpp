...
void init(void)
{
	...
	solarSystem.addPlanet(0, 1, 500, 695500, sun->getTextureHandle()); // sun (added as a planet)
	solarSystem.addPlanet(57910000, 88, 58.6, 2440, mercury->getTextureHandle()); // mercury
	solarSystem.addPlanet(108000000, 224.65, 243, 6052, venus->getTextureHandle()); // venus
	solarSystem.addPlanet(149600000, 365, 1, 6371, earth->getTextureHandle()); // earth
	solarSystem.addPlanet(227900000, 686, 1.03f, 3389, mars->getTextureHandle()); // mars
	...
	solarSystem.addPlanet(5906000000, 90616, 6.39, 1137, pluto->getTextureHandle()); // pluto
...
void display(void)
{
	...
	// draw the cube in which the star texture is rendered
...
// draw box in which starfield is rendered
void drawCube(void)
{
	glBegin(GL_QUADS);
	// new face
