...
#ifndef SAM_SOLARSYSTEM_H
#define SAM_SOLARSYSTEM_H
...
public:
	...
	// get the position in 3d space units of the given planet (specified by its index in the list) and put it into the 3d space
