...
int main(int argc, const char * argv[])
{
	...
	sphere1->GLSphere1(0.0, 0.0, 20.0, 7.5, 500, 500);
	sphere2->GLSphere2(0.0, 0.0, 0.0, 7.5, 500, 500);
	sphere3->GLSphere3(0.0, 0.0, -20.0, 7.5, 500, 500);
	sphere4->GLSphere4(0.0, 0.0, -40.0, 7.5, 500, 500);
    ...
    SetViewAsLookAt(glm::vec3(75.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
