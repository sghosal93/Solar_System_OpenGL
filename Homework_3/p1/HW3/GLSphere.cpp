...
void GLSphere::initShader1(void)
{
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	// Material
	_material._diffuse_material = glm::vec3(0.03, 0.0, 0.0);
	_material._ambient_material = glm::vec3(0.01, 0.0, 0.0);
	_material._specular_material = glm::vec3(0.01, 0.07, 0.07);
	_material._shininess = 50.0;
	...
	// define the position of the light and send the light position to your shader program
	_light_source0._lightPos = glm::vec4(300.0, 100.0, -300.0, 1.0);
	_light_source0._ambient_intensity = 3.0;
	_light_source0._specular_intensity = 15.0;
	_light_source0._diffuse_intensity = 50.0;
...
void GLSphere::initShader2(void)
{
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	// Material
	_material._diffuse_material = glm::vec3(0.0, 0.0, 0.12);
	_material._ambient_material = glm::vec3(0.0, 0.0, 0.1);
	_material._specular_material = glm::vec3(0.0, 0.0, 0.1);
	_material._shininess = 0.3;
	...
	// define the position of the light and send the light position to your shader program
	_light_source0._lightPos = glm::vec4(500.0, 40.0, -100.0, 1.0);
	_light_source0._ambient_intensity = 0.4;
...
void GLSphere::initShader3(void)
{
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	// Material
	_material._diffuse_material = glm::vec3(0.0, 0.8, 0.0);
	_material._ambient_material = glm::vec3(0.0, 0.8, 0.0);
	_material._specular_material = glm::vec3(0.2, 0.9, 0.2);
	_material._shininess = 80;
	...
	// define the position of the light and send the light position to your shader program
	_light_source1._lightPos = glm::vec4(37.5, -10.0, -25.0, 1.0);
	_light_source1._ambient_intensity = 0.0;
	_light_source1._specular_intensity = 7.5;
	_light_source1._diffuse_intensity = 100.0;
	_light_source1._attenuation_coeff = 0.0;

	_light_source1._cone_angle = 15.0; // in degree
	_light_source1._cone_direction = glm::vec3(-276.0, 140.0, 60.0); // this must be aligned with the object and light position.
...
void GLSphere::initShader4(void)
{
	...
	// This next section we'll generate the OpenGL program and attach the shaders to it so that we can render our triangle.
	_program = LoadAndCreateShaderProgram("../data/shaders/spotlight1.vs", "../data/shaders/spotlight1.fs");
	...
	_light_source0._lightPosIdx = glGetUniformLocation(_program, "light_position1");
	_light_source1._lightPosIdx = glGetUniformLocation(_program, "light_position");
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	// Material
	_material._diffuse_material = glm::vec3(1.00, 0.84, 0.0);
	_material._ambient_material = glm::vec3(1.00, 0.84, 0.0);
	_material._specular_material = glm::vec3(1.00, 0.84, 0.0);
	_material._shininess = 300.0;
	...
	// define the position of the light and send the light position to your shader program
	_light_source0._lightPos = glm::vec4(1000.0, -500.0, 400.0, 1.0);
	_light_source0._ambient_intensity = 0.0;
	_light_source0._specular_intensity = 5.0;
	_light_source0._diffuse_intensity = 1.0;

	_light_source0._ambientIdx = glGetUniformLocation(_program, "ambient_intensity1");
	_light_source0._diffuseIdx = glGetUniformLocation(_program, "diffuse_intensity1");
	_light_source0._specularIdx = glGetUniformLocation(_program, "specular_intensity1");
	...
	// define the position of the light and send the light position to your shader program
	_light_source1._lightPos = glm::vec4(37.5, 0.0, -45.0, 1.0);
	_light_source1._ambient_intensity = 0.0;
	_light_source1._specular_intensity = 8.0;
	_light_source1._diffuse_intensity = 1.5;

	_light_source1._cone_angle = 20.0;
	_light_source1._cone_direction = glm::vec3(-276.0, 140.0, 40.0);
